"""
Shell Registrar for LooP.

Handles the registration of LooP as the default system shell.
...
logger = logging.getLogger("loop.kernel.shell.registrar")

class ShellRegistrar:
    """
    Manages setting LooP as the default shell.
    """
    ...
    def register(self):
        """
        Registers LooP as the default shell for the current OS.
        """
    ...
    def _register_windows(self):
        ...
        restore_script = desktop / "loop-restore.bat"
        ...
        try:
            ...
            winreg.CloseKey(key)
            return {"success": True, "message": "LooP registered as Windows Shell. Sign out to apply."}
        except Exception as e:
    ...
    def _register_linux(self):
        ...
        """
        # Target: ~/.local/share/xsessions/loop.desktop
        ...
        desktop_file = session_dir / "loop.desktop"
