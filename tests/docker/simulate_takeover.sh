...
echo "[LooP] Simulating Kiosk Takeover..."
...
echo "[LooP] Creating /usr/share/xsessions/loop.desktop..."
sudo mkdir -p /usr/share/xsessions
cat <<EOF | sudo tee /usr/share/xsessions/loop.desktop
[Desktop Entry]
Name=LooP
Exec=loop start
Type=Application
...
echo "[LooP] Takeover Configuration Complete."
